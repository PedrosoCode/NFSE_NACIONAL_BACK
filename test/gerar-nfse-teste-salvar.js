...
const filename = `nfse-teste-${timestamp}-${dadosTeste.numero}.xml`;
...
console.log("\n💡 DICAS:");
console.log("- O arquivo XML foi salvo na mesma pasta deste script");
console.log("- Modifique os dados no início do arquivo e execute novamente");
console.log("- Cada execução gera um novo arquivo com timestamp diferente");