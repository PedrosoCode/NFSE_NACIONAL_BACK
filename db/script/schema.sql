...
\restrict j3IUhkYLrI8VnvRdXZmYO10oRVTL6CIcz4dbz53JIHclc3kKAIOebhk087gB3Cr

-- Dumped from database version 16.10 (Ubuntu 16.10-0ubuntu0.24.04.1)
-- Dumped by pg_dump version 16.10 (Ubuntu 16.10-0ubuntu0.24.04.1)

-- Started on 2025-10-01 21:51:48 -03
...
--
-- TOC entry 215 (class 1259 OID 16929)
...
--
-- TOC entry 216 (class 1259 OID 16932)
...
-- Name: tb_stc_servico; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_stc_servico (
    id integer NOT NULL,
    cod_tributacao character varying,
    item character varying,
    subitem character varying,
    desdobro character varying,
    descricao text NOT NULL
);


ALTER TABLE public.tb_stc_servico OWNER TO postgres;

--
-- TOC entry 226 (class 1259 OID 17165)
-- Name: nbs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.nbs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.nbs_id_seq OWNER TO postgres;

--
-- TOC entry 3487 (class 0 OID 0)
-- Dependencies: 226
-- Name: nbs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.nbs_id_seq OWNED BY public.tb_stc_servico.id;


--
-- TOC entry 217 (class 1259 OID 16935)
...
-- Name: tb_adm_perfil; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_adm_perfil (
    codigo integer NOT NULL,
    codigo_negocio integer NOT NULL,
    codigo_empresa integer NOT NULL,
    descricao character varying
);


ALTER TABLE public.tb_adm_perfil OWNER TO postgres;
...
-- Name: tb_cad_parceiro_negocio_contato; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_cad_parceiro_negocio_contato (
    codigo integer NOT NULL,
    codigo_negocio integer NOT NULL,
    codigo_empresa integer NOT NULL,
    codigo_parceiro_negocio integer NOT NULL,
...
ALTER TABLE public.tb_cad_parceiro_negocio_contato OWNER TO postgres;
...
-- Name: tb_stc_regime_tributario; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_stc_regime_tributario (
    codigo integer,
    descricao character varying
);


ALTER TABLE public.tb_stc_regime_tributario OWNER TO postgres;

--
-- TOC entry 224 (class 1259 OID 16977)
-- Name: tb_sys_negocio; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_sys_negocio (
    codigo integer NOT NULL,
    nome character varying
);


ALTER TABLE public.tb_sys_negocio OWNER TO postgres;

--
-- TOC entry 3295 (class 2604 OID 17169)
-- Name: tb_stc_servico id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_stc_servico ALTER COLUMN id SET DEFAULT nextval('public.nbs_id_seq'::regclass);


--
-- TOC entry 3469 (class 0 OID 16929)
-- Dependencies: 215
-- Data for Name: cidade; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cidade (codigo, nome, uf, ibge) FROM stdin;
...
--
-- TOC entry 3470 (class 0 OID 16932)
-- Dependencies: 216
-- Data for Name: estado; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.estado (codigo, nome, uf, ibge, pais, ddd) FROM stdin;
1	Acre	AC	12	1	68
...
--
-- TOC entry 3471 (class 0 OID 16935)
-- Dependencies: 217
-- Data for Name: pais; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pais (codigo, nome, nome_pt, sigla, bacen) FROM stdin;
...
249	Zona del Canal de Panamá	Zona do Canal do Panamá	\N	8958
...
--
-- TOC entry 3472 (class 0 OID 16938)
-- Dependencies: 218
-- Data for Name: tb_adm_perfil; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_adm_perfil (codigo, codigo_negocio, codigo_empresa, descricao) FROM stdin;
\.


--
-- TOC entry 3473 (class 0 OID 16943)
-- Dependencies: 219
-- Data for Name: tb_cad_empresa; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_cad_empresa (codigo_negocio, codigo, nome_fantasia, razao_social, cnpj_cpf) FROM stdin;
\.


--
-- TOC entry 3474 (class 0 OID 16948)
-- Dependencies: 220
-- Data for Name: tb_cad_item; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_cad_item (codigo, codigo_negocio, codigo_empresa, codigo_item, descricao) FROM stdin;
\.


--
-- TOC entry 3475 (class 0 OID 16959)
-- Dependencies: 221
-- Data for Name: tb_cad_parceiro_negocio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_cad_parceiro_negocio (codigo, codigo_negocio, codigo_empresa, nome_fantasia, razao_social, cnpj_cpf, codigo_pais, codigo_estado, codigo_cidade, bairro, rua, n_rua, cep, inscricao_estadual, cnae_principal, codigo_regime_tributario) FROM stdin;
\.


--
-- TOC entry 3476 (class 0 OID 16964)
-- Dependencies: 222
-- Data for Name: tb_cad_parceiro_negocio_contato; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_cad_parceiro_negocio_contato (codigo, codigo_negocio, codigo_empresa, codigo_parceiro_negocio, nome, email, telefone, cargo) FROM stdin;
\.


--
-- TOC entry 3477 (class 0 OID 16969)
-- Dependencies: 223
-- Data for Name: tb_cad_usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_cad_usuario (codigo, codigo_negocio, codigo_empresa, usuario, nome, senha) FROM stdin;
\.


--
-- TOC entry 3479 (class 0 OID 17151)
-- Dependencies: 225
-- Data for Name: tb_stc_regime_tributario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_stc_regime_tributario (codigo, descricao) FROM stdin;
\.


--
-- TOC entry 3481 (class 0 OID 17166)
-- Dependencies: 227
-- Data for Name: tb_stc_servico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_stc_servico (id, cod_tributacao, item, subitem, desdobro, descricao) FROM stdin;
1	\N	1	0	0	Serviços de Informática e congêneres.
2	\N	1	1	0	Análise e desenvolvimento de sistemas.
3	10101	1	1	1	Análise e desenvolvimento de sistemas.
4	\N	1	2	0	Programação.
5	10201	1	2	1	Programação.
6	\N	1	3	0	Processamento, armazenamento ou hospedagem de dados, textos, imagens, vídeos, páginas eletrônicas, aplicativos e sistemas de informação, entre outros formatos, e congêneres.
7	10301	1	3	1	Processamento de dados, textos, imagens, vídeos, páginas eletrônicas, aplicativos e sistemas de informação, entre outros formatos, e congêneres.
8	10302	1	3	2	Armazenamento ou hospedagem de dados, textos, imagens, vídeos, páginas eletrônicas, aplicativos e sistemas de informação, entre outros formatos, e congêneres.
9	\N	1	4	0	Elaboração de programas de computadores, inclusive de jogos eletrônicos, independentemente da arquitetura construtiva da máquina em que o programa será executado, incluindo tablets, smartphones e congêneres.
10	10401	1	4	1	Elaboração de programas de computadores, inclusive de jogos eletrônicos, independentemente da arquitetura construtiva da máquina em que o programa será executado, incluindo tablets, smartphones e congêneres.
11	\N	1	5	0	Licenciamento ou cessão de direito de uso de programas de computação.
12	10501	1	5	1	Licenciamento ou cessão de direito de uso de programas de computação.
13	\N	1	6	0	Assessoria e consultoria em informática.
14	10601	1	6	1	Assessoria e consultoria em informática.
15	\N	1	7	0	Suporte técnico em informática, inclusive instalação, configuração e manutenção de programas de computação e bancos de dados.
16	10701	1	7	1	Suporte técnico em informática, inclusive instalação, configuração e manutenção de programas de computação e bancos de dados.
17	\N	1	8	0	Planejamento, confecção, manutenção e atualização de páginas eletrônicas.
18	10801	1	8	1	Planejamento, confecção, manutenção e atualização de páginas eletrônicas.
19	\N	1	9	0	Disponibilização, sem cessão definitiva, de conteúdos de áudio, vídeo, imagem e texto por meio da internet, respeitada a imunidade de livros, jornais e periódicos (exceto a distribuição de conteúdos pelas prestadoras de Serviço de Acesso Condicionado, de que trata a Lei nº 12.485, de 12 de setembro de 2011, sujeita ao ICMS).
20	10901	1	9	1	Disponibilização, sem cessão definitiva, de conteúdos de áudio por meio da internet (exceto a distribuição de conteúdos pelas prestadoras de Serviço de Acesso Condicionado, de que trata a Lei nº 12.485, de 12 de setembro de 2011, sujeita ao ICMS).
21	10902	1	9	2	Disponibilização, sem cessão definitiva, de conteúdos de vídeo, imagem e texto por meio da internet, respeitada a imunidade de livros, jornais e periódicos (exceto a distribuição de conteúdos pelas prestadoras de Serviço de Acesso Condicionado, de que trata a Lei nº 12.485, de 12 de setembro de 2011, sujeita ao ICMS).
22	\N	2	0	0	Serviços de pesquisas e desenvolvimento de qualquer natureza.
23	\N	2	1	0	Serviços de pesquisas e desenvolvimento de qualquer natureza.
24	20101	2	1	1	Serviços de pesquisas e desenvolvimento de qualquer natureza.
25	\N	3	0	0	Serviços prestados mediante locação, cessão de direito de uso e congêneres.
26	\N	3	2	0	Cessão de direito de uso de marcas e de sinais de propaganda.
27	30201	3	2	1	Cessão de direito de uso de marcas e de sinais de propaganda.
28	\N	3	3	0	Exploração de salões de festas, centro de convenções, escritórios virtuais, stands, quadras esportivas, estádios, ginásios, auditórios, casas de espetáculos, parques de diversões, canchas e congêneres, para realização de eventos ou negócios de qualquer natureza.
29	30301	3	3	1	Exploração de salões de festas, centro de convenções, stands e congêneres, para realização de eventos ou negócios de qualquer natureza.
30	30302	3	3	2	Exploração de escritórios virtuais e congêneres, para realização de eventos ou negócios de qualquer natureza.
31	30303	3	3	3	Exploração de quadras esportivas, estádios, ginásios, canchas e congêneres, para realização de eventos ou negócios de qualquer natureza.
32	30304	3	3	4	Exploração de auditórios, casas de espetáculos e congêneres, para realização de eventos ou negócios de qualquer natureza.
33	30305	3	3	5	Exploração de parques de diversões e congêneres, para realização de eventos ou negócios de qualquer natureza.
34	\N	3	4	0	Locação, sublocação, arrendamento, direito de passagem ou permissão de uso, compartilhado ou não, de ferrovia, rodovia, postes, cabos, dutos e condutos de qualquer natureza.
35	30401	3	4	1	Locação, sublocação, arrendamento, direito de passagem ou permissão de uso, compartilhado ou não, de ferrovia.
36	30402	3	4	2	Locação, sublocação, arrendamento, direito de passagem ou permissão de uso, compartilhado ou não, de rodovia.
37	30403	3	4	3	Locação, sublocação, arrendamento, direito de passagem ou permissão de uso, compartilhado ou não, de postes, cabos, dutos e condutos de qualquer natureza.
38	\N	3	5	0	Cessão de andaimes, palcos, coberturas e outras estruturas de uso temporário.
39	30501	3	5	1	Cessão de andaimes, palcos, coberturas e outras estruturas de uso temporário.
40	\N	4	0	0	Serviços de saúde, assistência médica e congêneres.
41	\N	4	1	0	Medicina e biomedicina.
42	40101	4	1	1	Medicina.
43	40102	4	1	2	Biomedicina.
44	\N	4	2	0	Análises clínicas, patologia, eletricidade médica, radioterapia, quimioterapia, ultra-sonografia, ressonância magnética, radiologia, tomografia e congêneres.
45	40201	4	2	1	Análises clínicas e congêneres.
46	40202	4	2	2	Patologia e congêneres.
47	40203	4	2	3	Eletricidade médica (eletroestimulação de nervos e musculos, cardioversão, etc) e congêneres.
48	40204	4	2	4	Radioterapia, quimioterapia e congêneres.
49	40205	4	2	5	Ultra-sonografia, ressonância magnética, radiologia, tomografia e congêneres.
50	\N	4	3	0	Hospitais, clínicas, laboratórios, sanatórios, manicômios, casas de saúde, prontos-socorros, ambulatórios e congêneres.
51	40301	4	3	1	Hospitais e congêneres.
52	40302	4	3	2	Laboratórios e congêneres.
53	40303	4	3	3	Clínicas, sanatórios, manicômios, casas de saúde, prontos-socorros, ambulatórios e congêneres.
54	\N	4	4	0	Instrumentação cirúrgica.
55	40401	4	4	1	Instrumentação cirúrgica.
56	\N	4	5	0	Acupuntura.
57	40501	4	5	1	Acupuntura.
58	\N	4	6	0	Enfermagem, inclusive serviços auxiliares.
59	40601	4	6	1	Enfermagem, inclusive serviços auxiliares.
60	\N	4	7	0	Serviços farmacêuticos.
61	40701	4	7	1	Serviços farmacêuticos.
62	\N	4	8	0	Terapia ocupacional, fisioterapia e fonoaudiologia.
63	40801	4	8	1	Terapia ocupacional.
64	40802	4	8	2	Fisioterapia.
65	40803	4	8	3	Fonoaudiologia.
66	\N	4	9	0	Terapias de qualquer espécie destinadas ao tratamento físico, orgânico e mental.
67	40901	4	9	1	Terapias de qualquer espécie destinadas ao tratamento físico, orgânico e mental.
68	\N	4	10	0	Nutrição.
69	41001	4	10	1	Nutrição.
70	\N	4	11	0	Obstetrícia.
71	41101	4	11	1	Obstetrícia.
72	\N	4	12	0	Odontologia.
73	41201	4	12	1	Odontologia.
74	\N	4	13	0	Ortóptica.
75	41301	4	13	1	Ortóptica.
76	\N	4	14	0	Próteses sob encomenda.
77	41401	4	14	1	Próteses sob encomenda.
78	\N	4	15	0	Psicanálise.
79	41501	4	15	1	Psicanálise.
80	\N	4	16	0	Psicologia.
81	41601	4	16	1	Psicologia.
82	\N	4	17	0	Casas de repouso e de recuperação, creches, asilos e congêneres.
83	41701	4	17	1	Casas de repouso e congêneres.
84	41702	4	17	2	Casas de recuperação e congêneres.
85	41703	4	17	3	Creches e congêneres.
86	41704	4	17	4	Asilos e congêneres.
87	\N	4	18	0	Inseminação artificial, fertilização in vitro e congêneres.
88	41801	4	18	1	Inseminação artificial, fertilização in vitro e congêneres.
89	\N	4	19	0	Bancos de sangue, leite, pele, olhos, óvulos, sêmen e congêneres.
90	41901	4	19	1	Bancos de sangue, leite, pele, olhos, óvulos, sêmen e congêneres.
91	\N	4	20	0	Coleta de sangue, leite, tecidos, sêmen, órgãos e materiais biológicos de qualquer espécie.
92	42001	4	20	1	Coleta de sangue, leite, tecidos, sêmen, órgãos e materiais biológicos de qualquer espécie.
93	\N	4	21	0	Unidade de atendimento, assistência ou tratamento móvel e congêneres.
94	42101	4	21	1	Unidade de atendimento, assistência ou tratamento móvel e congêneres.
95	\N	4	22	0	Planos de medicina de grupo ou individual e convênios para prestação de assistência médica, hospitalar, odontológica e congêneres.
96	42201	4	22	1	Planos de medicina de grupo ou individual e convênios para prestação de assistência médica, hospitalar, odontológica e congêneres.
97	\N	4	23	0	Outros planos de saúde que se cumpram através de serviços de terceiros contratados, credenciados, cooperados ou apenas pagos pelo operador do plano mediante indicação do beneficiário.
98	42301	4	23	1	Outros planos de saúde que se cumpram através de serviços de terceiros contratados, credenciados, cooperados ou apenas pagos pelo operador do plano mediante indicação do beneficiário.
99	\N	5	0	0	Serviços de medicina e assistência veterinária e congêneres.
100	\N	5	1	0	Medicina veterinária e zootecnia.
101	50101	5	1	1	Medicina veterinária
102	50102	5	1	2	Zootecnia.
103	\N	5	2	0	Hospitais, clínicas, ambulatórios, prontos-socorros e congêneres, na área veterinária.
104	50201	5	2	1	Hospitais e congêneres, na área veterinária.
105	50202	5	2	2	Clínicas, ambulatórios, prontos-socorros e congêneres, na área veterinária.
106	\N	5	3	0	Laboratórios de análise na área veterinária.
107	50301	5	3	1	Laboratórios de análise na área veterinária.
108	\N	5	4	0	Inseminação artificial, fertilização in vitro e congêneres.
109	50401	5	4	1	Inseminação artificial, fertilização in vitro e congêneres.
110	\N	5	5	0	Bancos de sangue e de órgãos e congêneres.
111	50501	5	5	1	Bancos de sangue e de órgãos e congêneres.
112	\N	5	6	0	Coleta de sangue, leite, tecidos, sêmen, órgãos e materiais biológicos de qualquer espécie.
113	50601	5	6	1	Coleta de sangue, leite, tecidos, sêmen, órgãos e materiais biológicos de qualquer espécie.
114	\N	5	7	0	Unidade de atendimento, assistência ou tratamento móvel e congêneres.
115	50701	5	7	1	Unidade de atendimento, assistência ou tratamento móvel e congêneres.
116	\N	5	8	0	Guarda, tratamento, amestramento, embelezamento, alojamento e congêneres.
117	50801	5	8	1	Guarda, tratamento, amestramento, embelezamento, alojamento e congêneres.
118	\N	5	9	0	Planos de atendimento e assistência médico-veterinária.
119	50901	5	9	1	Planos de atendimento e assistência médico-veterinária.
120	\N	6	0	0	Serviços de cuidados pessoais, estética, atividades físicas e congêneres.
121	\N	6	1	0	Barbearia, cabeleireiros, manicuros, pedicuros e congêneres.
122	60101	6	1	1	Barbearia, cabeleireiros, manicuros, pedicuros e congêneres.
123	\N	6	2	0	Esteticistas, tratamento de pele, depilação e congêneres.
124	60201	6	2	1	Esteticistas, tratamento de pele, depilação e congêneres.
125	\N	6	3	0	Banhos, duchas, sauna, massagens e congêneres.
126	60301	6	3	1	Banhos, duchas, sauna, massagens e congêneres.
127	\N	6	4	0	Ginástica, dança, esportes, natação, artes marciais e demais atividades físicas.
128	60401	6	4	1	Ginástica, dança, esportes, natação, artes marciais e demais atividades físicas.
129	\N	6	5	0	Centros de emagrecimento, spa e congêneres.
130	60501	6	5	1	Centros de emagrecimento, spa e congêneres.
131	\N	6	6	0	Aplicação de tatuagens, piercings e congêneres.
132	60601	6	6	1	Aplicação de tatuagens, piercings e congêneres.
133	\N	7	0	0	Serviços relativos a engenharia, arquitetura, geologia, urbanismo, construção civil, manutenção, limpeza, meio ambiente, saneamento e congêneres.
134	\N	7	1	0	Engenharia, agronomia, agrimensura, arquitetura, geologia, urbanismo, paisagismo e congêneres.
135	70101	7	1	1	Engenharia e congêneres.
136	70102	7	1	2	Agronomia e congêneres.
137	70103	7	1	3	Agrimensura e congêneres.
138	70104	7	1	4	Arquitetura, urbanismo e congêneres.
139	70105	7	1	5	Geologia e congêneres.
140	70106	7	1	6	Paisagismo e congêneres.
141	\N	7	2	0	Execução, por administração, empreitada ou subempreitada, de obras de construção civil, hidráulica ou elétrica e de outras obras semelhantes, inclusive sondagem, perfuração de poços, escavação, drenagem e irrigação, terraplanagem, pavimentação, concretagem e a instalação e montagem de produtos, peças e equipamentos (exceto o fornecimento de mercadorias produzidas pelo prestador de serviços fora do local da prestação dos serviços, que fica sujeito ao ICMS).
142	70201	7	2	1	Execução, por administração, de obras de construção civil, hidráulica ou elétrica e de outras obras semelhantes, inclusive sondagem, perfuração de poços, escavação, drenagem e irrigação, terraplanagem, pavimentação, concretagem e a instalação e montagem de produtos, peças e equipamentos (exceto o fornecimento de mercadorias produzidas pelo prestador de serviços fora do local da prestação dos serviços, que fica sujeito ao ICMS).
143	70202	7	2	2	Execução, por empreitada ou subempreitada, de obras de construção civil, hidráulica ou elétrica e de outras obras semelhantes, inclusive sondagem, perfuração de poços, escavação, drenagem e irrigação, terraplanagem, pavimentação, concretagem e a instalação e montagem de produtos, peças e equipamentos (exceto o fornecimento de mercadorias produzidas pelo prestador de serviços fora do local da prestação dos serviços, que fica sujeito ao ICMS).
144	\N	7	3	0	Elaboração de planos diretores, estudos de viabilidade, estudos organizacionais e outros, relacionados com obras e serviços de engenharia; elaboração de anteprojetos, projetos básicos e projetos executivos para trabalhos de engenharia.
145	70301	7	3	1	Elaboração de planos diretores, estudos de viabilidade, estudos organizacionais e outros, relacionados com obras e serviços de engenharia.
146	70302	7	3	2	Elaboração de anteprojetos, projetos básicos e projetos executivos para trabalhos de engenharia.
147	\N	7	4	0	Demolição.
148	70401	7	4	1	Demolição.
149	\N	7	5	0	Reparação, conservação e reforma de edifícios, estradas, pontes, portos e congêneres (exceto o fornecimento de mercadorias produzidas pelo prestador dos serviços, fora do local da prestação dos serviços, que fica sujeito ao ICMS).
150	70501	7	5	1	Reparação, conservação e reforma de edifícios e congêneres (exceto o fornecimento de mercadorias produzidas pelo prestador dos serviços, fora do local da prestação dos serviços, que fica sujeito ao ICMS).
151	70502	7	5	2	Reparação, conservação e reforma de estradas, pontes, portos e congêneres (exceto o fornecimento de mercadorias produzidas pelo prestador dos serviços, fora do local da prestação dos serviços, que fica sujeito ao ICMS).
152	\N	7	6	0	Colocação e instalação de tapetes, carpetes, assoalhos, cortinas, revestimentos de parede, vidros, divisórias, placas de gesso e congêneres, com material fornecido pelo tomador do serviço.
153	70601	7	6	1	Colocação e instalação de tapetes, carpetes, cortinas e congêneres, com material fornecido pelo tomador do serviço.
154	70602	7	6	2	Colocação e instalação de assoalhos, revestimentos de parede, vidros, divisórias, placas de gesso e congêneres, com material fornecido pelo tomador do serviço.
155	\N	7	7	0	Recuperação, raspagem, polimento e lustração de pisos e congêneres.
156	70701	7	7	1	Recuperação, raspagem, polimento e lustração de pisos e congêneres.
157	\N	7	8	0	Calafetação.
158	70801	7	8	1	Calafetação.
159	\N	7	9	0	Varrição, coleta, remoção, incineração, tratamento, reciclagem, separação e destinação final de lixo, rejeitos e outros resíduos quaisquer.
160	70901	7	9	1	Varrição, coleta e remoção de lixo, rejeitos e outros resíduos quaisquer.
161	70902	7	9	2	Incineração, tratamento, reciclagem, separação e destinação final de lixo, rejeitos e outros resíduos quaisquer.
162	\N	7	10	0	Limpeza, manutenção e conservação de vias e logradouros públicos, imóveis, chaminés, piscinas, parques, jardins e congêneres.
163	71001	7	10	1	Limpeza, manutenção e conservação de vias e logradouros públicos, parques, jardins e congêneres.
164	71002	7	10	2	Limpeza, manutenção e conservação de imóveis, chaminés, piscinas e congêneres.
165	\N	7	11	0	Decoração e jardinagem, inclusive corte e poda de árvores.
166	71101	7	11	1	Decoração.
167	71102	7	11	2	Jardinagem, inclusive corte e poda de árvores.
168	\N	7	12	0	Controle e tratamento de efluentes de qualquer natureza e de agentes físicos, químicos e biológicos.
169	71201	7	12	1	Controle e tratamento de efluentes de qualquer natureza e de agentes físicos, químicos e biológicos.
170	\N	7	13	0	Dedetização, desinfecção, desinsetização, imunização, higienização, desratização, pulverização e congêneres.
171	71301	7	13	1	Dedetização, desinfecção, desinsetização, imunização, higienização, desratização, pulverização e congêneres.
172	\N	7	16	0	Florestamento, reflorestamento, semeadura, adubação, reparação de solo, plantio, silagem, colheita, corte e descascamento de árvores, silvicultura, exploração florestal e dos serviços congêneres indissociáveis da formação, manutenção e colheita de florestas, para quaisquer fins e por quaisquer meios.
173	71601	7	16	1	Florestamento, reflorestamento, semeadura, adubação, reparação de solo, plantio, silagem, colheita, corte e descascamento de árvores, silvicultura, exploração florestal e dos serviços congêneres indissociáveis da formação, manutenção e colheita de florestas, para quaisquer fins e por quaisquer meios.
174	\N	7	17	0	Escoramento, contenção de encostas e serviços congêneres.
175	71701	7	17	1	Escoramento, contenção de encostas e serviços congêneres.
176	\N	7	18	0	Limpeza e dragagem de rios, portos, canais, baías, lagos, lagoas, represas, açudes e congêneres.
177	71801	7	18	1	Limpeza e dragagem de rios, portos, canais, baías, lagos, lagoas, represas, açudes e congêneres.
178	\N	7	19	0	Acompanhamento e fiscalização da execução de obras de engenharia, arquitetura e urbanismo.
179	71901	7	19	1	Acompanhamento e fiscalização da execução de obras de engenharia, arquitetura e urbanismo.
180	\N	7	20	0	Aerofotogrametria (inclusive interpretação), cartografia, mapeamento, levantamentos topográficos, batimétricos, geográficos, geodésicos, geológicos, geofísicos e congêneres.
181	72001	7	20	1	Aerofotogrametria (inclusive interpretação), cartografia, mapeamento e congêneres.
182	72002	7	20	2	Levantamentos batimétricos, geográficos, geodésicos, geológicos, geofísicos e congêneres.
183	72003	7	20	3	Levantamentos topográficos e congêneres.
184	\N	7	21	0	Pesquisa, perfuração, cimentação, mergulho, perfilagem, concretação, testemunhagem, pescaria, estimulação e outros serviços relacionados com a exploração e explotação de petróleo, gás natural e de outros recursos minerais.
185	72101	7	21	1	Pesquisa, perfuração, cimentação, mergulho, perfilagem, concretação, testemunhagem, pescaria, estimulação e outros serviços relacionados com a exploração e explotação de petróleo, gás natural e de outros recursos minerais.
186	\N	7	22	0	Nucleação e bombardeamento de nuvens e congêneres.
187	72201	7	22	1	Nucleação e bombardeamento de nuvens e congêneres.
188	\N	8	0	0	Serviços de educação, ensino, orientação pedagógica e educacional, instrução, treinamento e avaliação pessoal de qualquer grau ou natureza.
189	\N	8	1	0	Ensino regular pré-escolar, fundamental, médio e superior.
190	80101	8	1	1	Ensino regular pré-escolar, fundamental e médio.
191	80102	8	1	2	Ensino regular superior.
192	\N	8	2	0	Instrução, treinamento, orientação pedagógica e educacional, avaliação de conhecimentos de qualquer natureza.
193	80201	8	2	1	Instrução, treinamento, orientação pedagógica e educacional, avaliação de conhecimentos de qualquer natureza.
194	\N	9	0	0	Serviços relativos a hospedagem, turismo, viagens e congêneres.
195	\N	9	1	0	Hospedagem de qualquer natureza em hotéis, apart-service condominiais, flat, apart-hotéis, hotéis residência, residence-service, suite service, hotelaria marítima, motéis, pensões e congêneres; ocupação por temporada com fornecimento de serviço (o valor da alimentação e gorjeta, quando incluído no preço da diária, fica sujeito ao Imposto Sobre Serviços).
196	90101	9	1	1	Hospedagem em hotéis, hotelaria marítima e congêneres (o valor da alimentação e gorjeta, quando incluído no preço da diária, fica sujeito ao Imposto Sobre Serviços).
197	90102	9	1	2	Hospedagem em pensões, albergues, pousadas, hospedarias, ocupação por temporada com fornecimento de serviços e congêneres (o valor da alimentação e gorjeta, quando incluído no preço da diária, fica sujeito ao Imposto Sobre Serviços).
198	90103	9	1	3	Hospedagem em motéis e congêneres (o valor da alimentação e gorjeta, quando incluído no preço da diária, fica sujeito ao Imposto Sobre Serviços).
199	90104	9	1	4	Hospedagem em apart-service condominiais, flat, apart-hotéis, hotéis residência, residence-service, suite service e congêneres (o valor da alimentação e gorjeta, quando incluído no preço da diária, fica sujeito ao Imposto Sobre Serviços).
200	\N	9	2	0	Agenciamento, organização, promoção, intermediação e execução de programas de turismo, passeios, viagens, excursões, hospedagens e congêneres.
201	90201	9	2	1	Agenciamento e intermediação de programas de turismo, passeios, viagens, excursões, hospedagens e congêneres.
202	90202	9	2	2	Organização, promoção e execução de programas de turismo, passeios, viagens, excursões, hospedagens e congêneres.
203	\N	9	3	0	Guias de turismo.
204	90301	9	3	1	Guias de turismo.
205	\N	10	0	0	Serviços de intermediação e congêneres.
206	\N	10	1	0	Agenciamento, corretagem ou intermediação de câmbio, de seguros, de cartões de crédito, de planos de saúde e de planos de previdência privada.
207	100101	10	1	1	Agenciamento, corretagem ou intermediação de câmbio.
208	100102	10	1	2	Agenciamento, corretagem ou intermediação de seguros.
209	100103	10	1	3	Agenciamento, corretagem ou intermediação de cartões de crédito.
210	100104	10	1	4	Agenciamento, corretagem ou intermediação de planos de saúde.
211	100105	10	1	5	Agenciamento, corretagem ou intermediação de planos de previdência privada.
212	\N	10	2	0	Agenciamento, corretagem ou intermediação de títulos em geral, valores mobiliários e contratos quaisquer.
213	100201	10	2	1	Agenciamento, corretagem ou intermediação de títulos em geral e valores mobiliários.
214	100202	10	2	2	Agenciamento, corretagem ou intermediação de contratos quaisquer.
215	\N	10	3	0	Agenciamento, corretagem ou intermediação de direitos de propriedade industrial, artística ou literária.
216	100301	10	3	1	Agenciamento, corretagem ou intermediação de direitos de propriedade industrial, artística ou literária.
217	\N	10	4	0	Agenciamento, corretagem ou intermediação de contratos de arrendamento mercantil (leasing), de franquia (franchising) e de faturização (factoring).
218	100401	10	4	1	Agenciamento, corretagem ou intermediação de contratos de arrendamento mercantil (leasing).
219	100402	10	4	2	Agenciamento, corretagem ou intermediação de contratos de franquia (franchising).
220	100403	10	4	3	Agenciamento, corretagem ou intermediação de faturização (factoring).
221	\N	10	5	0	Agenciamento, corretagem ou intermediação de bens móveis ou imóveis, não abrangidos em outros itens ou subitens, inclusive aqueles realizados no âmbito de Bolsas de Mercadorias e Futuros, por quaisquer meios.
222	100501	10	5	1	Agenciamento, corretagem ou intermediação de bens móveis ou imóveis, não abrangidos em outros itens ou subitens, por quaisquer meios.
223	100502	10	5	2	Agenciamento, corretagem ou intermediação de bens móveis ou imóveis realizados no âmbito de Bolsas de Mercadorias e Futuros, por quaisquer meios.
224	\N	10	6	0	Agenciamento marítimo.
225	100601	10	6	1	Agenciamento marítimo.
226	\N	10	7	0	Agenciamento de notícias.
227	100701	10	7	1	Agenciamento de notícias.
228	\N	10	8	0	Agenciamento de publicidade e propaganda, inclusive o agenciamento de veiculação por quaisquer meios.
229	100801	10	8	1	Agenciamento de publicidade e propaganda, inclusive o agenciamento de veiculação por quaisquer meios.
230	\N	10	9	0	Representação de qualquer natureza, inclusive comercial.
231	100901	10	9	1	Representação de qualquer natureza, inclusive comercial.
232	\N	10	10	0	Distribuição de bens de terceiros.
233	101001	10	10	1	Distribuição de bens de terceiros.
234	\N	11	0	0	Serviços de guarda, estacionamento, armazenamento, vigilância e congêneres.
455	\N	17	14	0	Advocacia
235	\N	11	1	0	Guarda e estacionamento de veículos terrestres automotores, de aeronaves e de embarcações.
236	110101	11	1	1	Guarda e estacionamento de veículos terrestres automotores.
237	110102	11	1	2	Guarda e estacionamento de aeronaves e de embarcações.
238	\N	11	2	0	Vigilância, segurança ou monitoramento de bens, pessoas e semoventes.
239	110201	11	2	1	Vigilância, segurança ou monitoramento de bens, pessoas e semoventes.
240	\N	11	3	0	Escolta, inclusive de veículos e cargas.
241	110301	11	3	1	Escolta, inclusive de veículos e cargas.
242	\N	11	4	0	Armazenamento, depósito, carga, descarga, arrumação e guarda de bens de qualquer espécie.
243	110401	11	4	1	Armazenamento, depósito, guarda de bens de qualquer espécie.
244	110402	11	4	2	Carga, descarga, arrumação de bens de qualquer espécie.
245	\N	12	0	0	Serviços de diversões, lazer, entretenimento e congêneres.
246	\N	12	1	0	Espetáculos teatrais.
247	120101	12	1	1	Espetáculos teatrais.
248	\N	12	2	0	Exibições cinematográficas.
249	120201	12	2	1	Exibições cinematográficas.
250	\N	12	3	0	Espetáculos circenses.
251	120301	12	3	1	Espetáculos circenses.
252	\N	12	4	0	Programas de auditório.
253	120401	12	4	1	Programas de auditório.
254	\N	12	5	0	Parques de diversões, centros de lazer e congêneres.
255	120501	12	5	1	Parques de diversões, centros de lazer e congêneres.
256	\N	12	6	0	Boates, taxi-dancing e congêneres.
257	120601	12	6	1	Boates, taxi-dancing e congêneres.
258	\N	12	7	0	Shows, ballet, danças, desfiles, bailes, óperas, concertos, recitais, festivais e congêneres.
259	120701	12	7	1	Shows, ballet, danças, desfiles, bailes, óperas, concertos, recitais, festivais e congêneres.
260	\N	12	8	0	Feiras, exposições, congressos e congêneres.
261	120801	12	8	1	Feiras, exposições, congressos e congêneres.
262	\N	12	9	0	Bilhares, boliches e diversões eletrônicas ou não.
263	120901	12	9	1	Bilhares.
264	120902	12	9	2	Boliches.
265	120903	12	9	3	Diversões eletrônicas ou não.
266	\N	12	10	0	Corridas e competições de animais.
267	121001	12	10	1	Corridas e competições de animais.
268	\N	12	11	0	Competições esportivas ou de destreza física ou intelectual, com ou sem a participação do espectador.
269	121101	12	11	1	Competições esportivas ou de destreza física ou intelectual, com ou sem a participação do espectador.
270	\N	12	12	0	Execução de música.
271	121201	12	12	1	Execução de música.
272	\N	12	13	0	Produção, mediante ou sem encomenda prévia, de eventos, espetáculos, entrevistas, shows, ballet, danças, desfiles, bailes, teatros, óperas, concertos, recitais, festivais e congêneres.
273	121301	12	13	1	Produção, mediante ou sem encomenda prévia, de eventos, espetáculos, entrevistas, shows, ballet, danças, desfiles, bailes, teatros, óperas, concertos, recitais, festivais e congêneres.
274	\N	12	14	0	Fornecimento de música para ambientes fechados ou não, mediante transmissão por qualquer processo.
275	121401	12	14	1	Fornecimento de música para ambientes fechados ou não, mediante transmissão por qualquer processo.
276	\N	12	15	0	Desfiles de blocos carnavalescos ou folclóricos, trios elétricos e congêneres.
277	121501	12	15	1	Desfiles de blocos carnavalescos ou folclóricos, trios elétricos e congêneres.
278	\N	12	16	0	Exibição de filmes, entrevistas, musicais, espetáculos, shows, concertos, desfiles, óperas, competições esportivas, de destreza intelectual ou congêneres.
279	121601	12	16	1	Exibição de filmes, entrevistas, musicais, espetáculos, shows, concertos, desfiles, óperas, competições esportivas, de destreza intelectual ou congêneres.
280	\N	12	17	0	Recreação e animação, inclusive em festas e eventos de qualquer natureza.
281	121701	12	17	1	Recreação e animação, inclusive em festas e eventos de qualquer natureza.
282	\N	13	0	0	Serviços relativos a fonografia, fotografia, cinematografia e reprografia.
283	\N	13	2	0	Fonografia ou gravação de sons, inclusive trucagem, dublagem, mixagem e congêneres.
284	130201	13	2	1	Fonografia ou gravação de sons, inclusive trucagem, dublagem, mixagem e congêneres.
285	\N	13	3	0	Fotografia e cinematografia, inclusive revelação, ampliação, cópia, reprodução, trucagem e congêneres.
286	130301	13	3	1	Fotografia e cinematografia, inclusive revelação, ampliação, cópia, reprodução, trucagem e congêneres.
287	\N	13	4	0	Reprografia, microfilmagem e digitalização.
288	130401	13	4	1	Reprografia, microfilmagem e digitalização.
289	\N	13	5	0	Composição gráfica, inclusive confecção de impressos gráficos, fotocomposição, clicheria, zincografia, litografia e fotolitografia, exceto se destinados a posterior operação de comercialização ou industrialização, ainda que incorporados, de qualquer forma, a outra mercadoria que deva ser objeto de posterior circulação, tais como bulas, rótulos, etiquetas, caixas, cartuchos, embalagens e manuais técnicos e de instrução, quando ficarão sujeitos ao ICMS.
290	130501	13	5	1	Composição gráfica, inclusive confecção de impressos gráficos, fotocomposição, clicheria, zincografia, litografia e fotolitografia, exceto se destinados a posterior operação de comercialização ou industrialização, ainda que incorporados, de qualquer forma, a outra mercadoria que deva ser objeto de posterior circulação, tais como bulas, rótulos, etiquetas, caixas, cartuchos, embalagens e manuais técnicos e de instrução, quando ficarão sujeitos ao ICMS.
291	\N	14	0	0	Serviços relativos a bens de terceiros.
292	\N	14	1	0	Lubrificação, limpeza, lustração, revisão, carga e recarga, conserto, restauração, blindagem, manutenção e conservação de máquinas, veículos, aparelhos, equipamentos, motores, elevadores ou de qualquer objeto (exceto peças e partes empregadas, que ficam sujeitas ao ICMS).
293	140101	14	1	1	Lubrificação, limpeza, lustração, revisão, carga e recarga, conserto, restauração, blindagem, manutenção e conservação de máquinas, veículos, aparelhos, equipamentos, motores, elevadores ou de qualquer objeto (exceto peças e partes empregadas, que ficam sujeitas ao ICMS).
294	\N	14	2	0	Assistência técnica.
295	140201	14	2	1	Assistência técnica.
296	\N	14	3	0	Recondicionamento de motores (exceto peças e partes empregadas, que ficam sujeitas ao ICMS).
297	140301	14	3	1	Recondicionamento de motores (exceto peças e partes empregadas, que ficam sujeitas ao ICMS).
298	\N	14	4	0	Recauchutagem ou regeneração de pneus.
299	140401	14	4	1	Recauchutagem ou regeneração de pneus.
300	\N	14	5	0	Restauração, recondicionamento, acondicionamento, pintura, beneficiamento, lavagem, secagem, tingimento, galvanoplastia, anodização, corte, recorte, plastificação, costura, acabamento, polimento e congêneres de objetos quaisquer.
301	140501	14	5	1	Restauração, recondicionamento, acondicionamento, pintura, beneficiamento, lavagem, secagem, tingimento, galvanoplastia, anodização, corte, recorte, plastificação, costura, acabamento, polimento e congêneres de objetos quaisquer.
302	\N	14	6	0	Instalação e montagem de aparelhos, máquinas e equipamentos, inclusive montagem industrial, prestados ao usuário final, exclusivamente com material por ele fornecido.
303	140601	14	6	1	Instalação e montagem de aparelhos, máquinas e equipamentos, inclusive montagem industrial, prestados ao usuário final, exclusivamente com material por ele fornecido.
304	\N	14	7	0	Colocação de molduras e congêneres.
305	140701	14	7	1	Colocação de molduras e congêneres.
306	\N	14	8	0	Encadernação, gravação e douração de livros, revistas e congêneres.
307	140801	14	8	1	Encadernação, gravação e douração de livros, revistas e congêneres.
308	\N	14	9	0	Alfaiataria e costura, quando o material for fornecido pelo usuário final, exceto aviamento.
309	140901	14	9	1	Alfaiataria e costura, quando o material for fornecido pelo usuário final, exceto aviamento.
310	\N	14	10	0	Tinturaria e lavanderia.
311	141001	14	10	1	Tinturaria e lavanderia.
312	\N	14	11	0	Tapeçaria e reforma de estofamentos em geral.
313	141101	14	11	1	Tapeçaria e reforma de estofamentos em geral.
314	\N	14	12	0	Funilaria e lanternagem.
315	141201	14	12	1	Funilaria e lanternagem.
316	\N	14	13	0	Carpintaria e serralheria.
317	141301	14	13	1	Carpintaria.
318	141302	14	13	2	Serralheria.
319	\N	14	14	0	Guincho intramunicipal, guindaste e içamento.
320	141401	14	14	1	Guincho intramunicipal.
321	141402	14	14	2	Guindaste e içamento.
322	\N	15	0	0	Serviços relacionados ao setor bancário ou financeiro, inclusive aqueles prestados por instituições financeiras autorizadas a funcionar pela União ou por quem de direito.
323	\N	15	1	0	Administração de fundos quaisquer, de consórcio, de cartão de crédito ou débito e congêneres, de carteira de clientes, de cheques pré-datados e congêneres.
324	150101	15	1	1	Administração de fundos quaisquer e congêneres.
325	150102	15	1	2	Administração de consórcio e congêneres.
326	150103	15	1	3	Administração de cartão de crédito ou débito e congêneres.
327	150104	15	1	4	Administração de carteira de clientes e congêneres.
328	150105	15	1	5	Administração de cheques pré-datados e congêneres.
329	\N	15	2	0	Abertura de contas em geral, inclusive conta-corrente, conta de investimentos e aplicação e caderneta de poupança, no País e no exterior, bem como a manutenção das referidas contas ativas e inativas.
330	150201	15	2	1	Abertura de conta-corrente no País, bem como a manutenção da referida conta ativa e inativa.
331	150202	15	2	2	Abertura de conta-corrente no exterior, bem como a manutenção da referida conta ativa e inativa.
332	150203	15	2	3	Abertura de conta de investimentos e aplicação no País, bem como a manutenção da referida conta ativa e inativa.
333	150204	15	2	4	Abertura de conta de investimentos e aplicação no exterior, bem como a manutenção da referida conta ativa e inativa.
334	150205	15	2	5	Abertura de caderneta de poupança no País, bem como a manutenção da referida conta ativa e inativa.
335	150206	15	2	6	Abertura de caderneta de poupança no exterior, bem como a manutenção da referida conta ativa e inativa.
336	150207	15	2	7	Abertura de contas em geral no País, não abrangida em outro subitem, bem como a manutenção das referidas contas ativas e inativas.
337	150208	15	2	8	Abertura de contas em geral no exterior, não abrangida em outro subitem, bem como a manutenção das referidas contas ativas e inativas.
338	\N	15	3	0	Locação e manutenção de cofres particulares, de terminais eletrônicos, de terminais de atendimento e de bens e equipamentos em geral.
339	150301	15	3	1	Locação de cofres particulares.
340	150302	15	3	2	Manutenção de cofres particulares.
341	150303	15	3	3	Locação de terminais eletrônicos.
342	150304	15	3	4	Manutenção de terminais eletrônicos.
343	150305	15	3	5	Locação de terminais de atendimento.
344	150306	15	3	6	Manutenção de terminais de atendimento.
345	150307	15	3	7	Locação de bens e equipamentos em geral.
346	150308	15	3	8	Manutenção de bens e equipamentos em geral.
347	\N	15	4	0	Fornecimento ou emissão de atestados em geral, inclusive atestado de idoneidade, atestado de capacidade financeira e congêneres.
348	150401	15	4	1	Fornecimento ou emissão de atestados em geral, inclusive atestado de idoneidade, atestado de capacidade financeira e congêneres.
349	\N	15	5	0	Cadastro, elaboração de ficha cadastral, renovação cadastral e congêneres, inclusão ou exclusão no Cadastro de Emitentes de Cheques sem Fundos - CCF ou em quaisquer outros bancos cadastrais.
350	150501	15	5	1	Cadastro, elaboração de ficha cadastral, renovação cadastral e congêneres.
351	150502	15	5	2	Inclusão no Cadastro de Emitentes de Cheques sem Fundos - CCF.
352	150503	15	5	3	Exclusão no Cadastro de Emitentes de Cheques sem Fundos - CCF.
353	150504	15	5	4	Inclusão em quaisquer outros bancos cadastrais.
354	150505	15	5	5	Exclusão em quaisquer outros bancos cadastrais.
397	\N	15	15	0	Compensação de cheques e títulos quaisquer; serviços relacionados a depósito, inclusive depósito identificado, a saque de contas quaisquer, por qualquer meio ou processo, inclusive em terminais eletrônicos e de atendimento.
398	151501	15	15	1	Compensação de cheques e títulos quaisquer.
355	\N	15	6	0	Emissão, reemissão e fornecimento de avisos, comprovantes e documentos em geral; abono de firmas; coleta e entrega de documentos, bens e valores; comunicação com outra agência ou com a administração central; licenciamento eletrônico de veículos; transferência de veículos; agenciamento fiduciário ou depositário; devolução de bens em custódia.
356	150601	15	6	1	Emissão, reemissão e fornecimento de avisos, comprovantes e documentos em geral
357	150602	15	6	2	Abono de firmas.
358	150603	15	6	3	Coleta e entrega de documentos, bens e valores.
359	150604	15	6	4	Comunicação com outra agência ou com a administração central.
360	150605	15	6	5	Licenciamento eletrônico de veículos.
361	150606	15	6	6	Transferência de veículos.
362	150607	15	6	7	Agenciamento fiduciário ou depositário.
363	150608	15	6	8	Devolução de bens em custódia.
364	\N	15	7	0	Acesso, movimentação, atendimento e consulta a contas em geral, por qualquer meio ou processo, inclusive por telefone, fac-símile, internet e telex, acesso a terminais de atendimento, inclusive vinte e quatro horas; acesso a outro banco e à rede compartilhada; fornecimento de saldo, extrato e demais informações relativas a contas em geral, por qualquer meio ou processo.
365	150701	15	7	1	Acesso, movimentação, atendimento e consulta a contas em geral, por qualquer meio ou processo, inclusive por telefone, fac-símile, internet e telex.
366	150702	15	7	2	Acesso a terminais de atendimento, inclusive vinte e quatro horas.
367	150703	15	7	3	Acesso a outro banco e à rede compartilhada.
368	150704	15	7	4	Fornecimento de saldo, extrato e demais informações relativas a contas em geral, por qualquer meio ou processo.
369	\N	15	8	0	Emissão, reemissão, alteração, cessão, substituição, cancelamento e registro de contrato de crédito; estudo, análise e avaliação de operações de crédito; emissão, concessão, alteração ou contratação de aval, fiança, anuência e congêneres; serviços relativos à abertura de crédito, para quaisquer fins.
370	150801	15	8	1	Emissão, reemissão, alteração, cessão, substituição, cancelamento e registro de contrato de crédito.
371	150802	15	8	2	Estudo, análise e avaliação de operações de crédito.
372	150803	15	8	3	Emissão, concessão, alteração ou contratação de aval, fiança, anuência e congêneres.
373	150804	15	8	4	Serviços relativos à abertura de crédito, para quaisquer fins.
374	\N	15	9	0	Arrendamento mercantil (leasing) de quaisquer bens, inclusive cessão de direitos e obrigações, substituição de garantia, alteração, cancelamento e registro de contrato, e demais serviços relacionados ao arrendamento mercantil (leasing).
375	150901	15	9	1	Arrendamento mercantil (leasing) de quaisquer bens, inclusive cessão de direitos e obrigações, substituição de garantia, alteração, cancelamento e registro de contrato, e demais serviços relacionados ao arrendamento mercantil (leasing).
376	\N	15	10	0	Serviços relacionados a cobranças, recebimentos ou pagamentos em geral, de títulos quaisquer, de contas ou carnês, de câmbio, de tributos e por conta de terceiros, inclusive os efetuados por meio eletrônico, automático ou por máquinas de atendimento; fornecimento de posição de cobrança, recebimento ou pagamento; emissão de carnês, fichas de compensação, impressos e documentos em geral.
377	151001	15	10	1	Serviços relacionados a cobranças em geral, de títulos quaisquer, de contas ou carnês, de câmbio, de tributos e por conta de terceiros, inclusive os efetuados por meio eletrônico, automático ou por máquinas de atendimento.
378	151002	15	10	2	Serviços relacionados a recebimentos em geral, de títulos quaisquer, de contas ou carnês, de câmbio, de tributos e por conta de terceiros, inclusive os efetuados por meio eletrônico, automático ou por máquinas de atendimento.
379	151003	15	10	3	Serviços relacionados a pagamentos em geral, de títulos quaisquer, de contas ou carnês, de câmbio, de tributos e por conta de terceiros, inclusive os efetuados por meio eletrônico, automático ou por máquinas de atendimento.
380	151004	15	10	4	Serviços relacionados a fornecimento de posição de cobrança, recebimento ou pagamento.
381	151005	15	10	5	Serviços relacionados a emissão de carnês, fichas de compensação, impressos e documentos em geral.
382	\N	15	11	0	Devolução de títulos, protesto de títulos, sustação de protesto, manutenção de títulos, reapresentação de títulos, e demais serviços a eles relacionados.
383	151101	15	11	1	Devolução de títulos, protesto de títulos, sustação de protesto, manutenção de títulos, reapresentação de títulos, e demais serviços a eles relacionados.
384	\N	15	12	0	Custódia em geral, inclusive de títulos e valores mobiliários.
385	151201	15	12	1	Custódia em geral, inclusive de títulos e valores mobiliários.
386	\N	15	13	0	Serviços relacionados a operações de câmbio em geral, edição, alteração, prorrogação, cancelamento e baixa de contrato de câmbio; emissão de registro de exportação ou de crédito; cobrança ou depósito no exterior; emissão, fornecimento e cancelamento de cheques de viagem; fornecimento, transferência, cancelamento e demais serviços relativos a carta de crédito de importação, exportação e garantias recebidas; envio e recebimento de mensagens em geral relacionadas a operações de câmbio.
387	151301	15	13	1	Serviços relacionados a operações de câmbio em geral, edição, alteração, prorrogação, cancelamento e baixa de contrato de câmbio.
388	151302	15	13	2	Serviços relacionados a emissão de registro de exportação ou de crédito.
389	151303	15	13	3	Serviços relacionados a cobrança ou depósito no exterior.
390	151304	15	13	4	Serviços relacionados a emissão, fornecimento e cancelamento de cheques de viagem.
391	151305	15	13	5	Serviços relacionados a fornecimento, transferência, cancelamento e demais serviços relativos a carta de crédito de importação, exportação e garantias recebidas.
392	151306	15	13	6	Serviços relacionados a envio e recebimento de mensagens em geral relacionadas a operações de câmbio.
393	\N	15	14	0	Fornecimento, emissão, reemissão, renovação e manutenção de cartão magnético, cartão de crédito, cartão de débito, cartão salário e congêneres.
394	151401	15	14	1	Fornecimento, emissão, reemissão de cartão magnético, cartão de crédito, cartão de débito, cartão salário e congêneres.
395	151402	15	14	2	Renovação de cartão magnético, cartão de crédito, cartão de débito, cartão salário e congêneres.
396	151403	15	14	3	Manutenção de cartão magnético, cartão de crédito, cartão de débito, cartão salário e congêneres.
399	151502	15	15	2	Serviços relacionados a depósito, inclusive depósito identificado, a saque de contas quaisquer, por qualquer meio ou processo, inclusive em terminais eletrônicos e de atendimento.
400	\N	15	16	0	Emissão, reemissão, liquidação, alteração, cancelamento e baixa de ordens de pagamento, ordens de crédito e similares, por qualquer meio ou processo; serviços relacionados à transferência de valores, dados, fundos, pagamentos e similares, inclusive entre contas em geral.
401	151601	15	16	1	Emissão, reemissão, liquidação, alteração, cancelamento e baixa de ordens de pagamento, ordens de crédito e similares, por qualquer meio ou processo.
402	151602	15	16	2	Serviços relacionados à transferência de valores, dados, fundos, pagamentos e similares, inclusive entre contas em geral.
403	\N	15	17	0	Emissão, fornecimento, devolução, sustação, cancelamento e oposição de cheques quaisquer, avulso ou por talão.
404	151701	15	17	1	Emissão e fornecimento de cheques quaisquer, avulso ou por talão.
405	151702	15	17	2	Devolução de cheques quaisquer, avulso ou por talão.
406	151703	15	17	3	Sustação, cancelamento e oposição de cheques quaisquer, avulso ou por talão.
407	\N	15	18	0	Serviços relacionados a crédito imobiliário, avaliação e vistoria de imóvel ou obra, análise técnica e jurídica, emissão, reemissão, alteração, transferência e renegociação de contrato, emissão e reemissão do termo de quitação e demais serviços relacionados a crédito imobiliário.
408	151801	15	18	1	Serviços relacionados a crédito imobiliário, de avaliação e vistoria de imóvel ou obra.
409	151802	15	18	2	Serviços relacionados a crédito imobiliário, de análise técnica e jurídica.
410	151803	15	18	3	Serviços relacionados a crédito imobiliário, de emissão, reemissão, alteração, transferência e renegociação de contrato.
411	151804	15	18	4	Serviços relacionados a crédito imobiliário, de emissão e reemissão do termo de quitação.
412	151805	15	18	5	Demais serviços relacionados a crédito imobiliário.
413	\N	16	0	0	Serviços de transporte de natureza municipal.
414	\N	16	1	0	Serviços de transporte coletivo municipal rodoviário, metroviário, ferroviário e aquaviário de passageiros.
415	160101	16	1	1	Serviços de transporte coletivo municipal rodoviário de passageiros.
416	160102	16	1	2	Serviços de transporte coletivo municipal metroviário de passageiros.
417	160103	16	1	3	Serviços de transporte coletivo municipal ferroviário de passageiros.
418	160104	16	1	4	Serviços de transporte coletivo municipal aquaviário de passageiros.
419	\N	16	2	0	Outros serviços de transporte de natureza municipal.
420	160201	16	2	1	Outros serviços de transporte de natureza municipal.
421	\N	17	0	0	Serviços de apoio técnico, administrativo, jurídico, contábil, comercial e congêneres.
422	\N	17	1	0	Assessoria ou consultoria de qualquer natureza, não contida em outros itens desta lista; análise, exame, pesquisa, coleta, compilação e fornecimento de dados e informações de qualquer natureza, inclusive cadastro e similares.
423	170101	17	1	1	Assessoria ou consultoria de qualquer natureza, não contida em outros itens desta lista.
424	170102	17	1	2	Análise, exame, pesquisa, coleta, compilação e fornecimento de dados e informações de qualquer natureza, inclusive cadastro e similares.
425	\N	17	2	0	Datilografia, digitação, estenografia, expediente, secretaria em geral, resposta audível, redação, edição, interpretação, revisão, tradução, apoio e infra-estrutura administrativa e congêneres.
426	170201	17	2	1	Datilografia, digitação, estenografia e congêneres.
427	170202	17	2	2	Expediente, secretaria em geral, apoio e infra-estrutura administrativa e congêneres.
428	170203	17	2	3	Resposta audível e congêneres.
429	170204	17	2	4	Redação, edição, revisão e congêneres.
430	170205	17	2	5	Interpretação, tradução e congêneres.
431	\N	17	3	0	Planejamento, coordenação, programação ou organização técnica, financeira ou administrativa.
432	170301	17	3	1	Planejamento, coordenação, programação ou organização técnica.
433	170302	17	3	2	Planejamento, coordenação, programação ou organização financeira.
434	170303	17	3	3	Planejamento, coordenação, programação ou organização administrativa.
435	\N	17	4	0	Recrutamento, agenciamento, seleção e colocação de mão-de-obra.
436	170401	17	4	1	Recrutamento, agenciamento, seleção e colocação de mão-de-obra.
437	\N	17	5	0	Fornecimento de mão-de-obra, mesmo em caráter temporário, inclusive de empregados ou trabalhadores, avulsos ou temporários, contratados pelo prestador de serviço.
438	170501	17	5	1	Fornecimento de mão-de-obra, mesmo em caráter temporário, inclusive de empregados ou trabalhadores, avulsos ou temporários, contratados pelo prestador de serviço.
439	\N	17	6	0	Propaganda e publicidade, inclusive promoção de vendas, planejamento de campanhas ou sistemas de publicidade, elaboração de desenhos, textos e demais materiais publicitários.
440	170601	17	6	1	Propaganda e publicidade, inclusive promoção de vendas, planejamento de campanhas ou sistemas de publicidade, elaboração de desenhos, textos e demais materiais publicitários.
441	\N	17	8	0	Franquia (franchising).
442	170801	17	8	1	Franquia (franchising).
443	\N	17	9	0	Perícias, laudos, exames técnicos e análises técnicas.
444	170901	17	9	1	Perícias, laudos, exames técnicos e análises técnicas.
445	\N	17	10	0	Planejamento, organização e administração de feiras, exposições, congressos e congêneres.
446	171001	17	10	1	Planejamento, organização e administração de feiras, exposições, e congêneres.
447	171002	17	10	2	Planejamento, organização e administração de congressos e congêneres.
448	\N	17	11	0	Organização de festas e recepções; bufê (exceto o fornecimento de alimentação e bebidas, que fica sujeito ao ICMS).
449	171101	17	11	1	Organização de festas e recepções.
450	171102	17	11	2	Bufê (exceto o fornecimento de alimentação e bebidas, que fica sujeito ao ICMS).
451	\N	17	12	0	Administração em geral, inclusive de bens e negócios de terceiros.
452	171201	17	12	1	Administração em geral, inclusive de bens e negócios de terceiros.
453	\N	17	13	0	Leilão e congêneres.
454	171301	17	13	1	Leilão e congêneres.
456	171401	17	14	1	Advocacia
457	\N	17	15	0	Arbitragem de qualquer espécie, inclusive jurídica.
458	171501	17	15	1	Arbitragem de qualquer espécie, inclusive jurídica.
459	\N	17	16	0	Auditoria.
460	171601	17	16	1	Auditoria.
461	\N	17	17	0	Análise de Organização e Métodos.
462	171701	17	17	1	Análise de Organização e Métodos.
463	\N	17	18	0	Atuária e cálculos técnicos de qualquer natureza.
464	171801	17	18	1	Atuária e cálculos técnicos de qualquer natureza.
465	\N	17	19	0	Contabilidade, inclusive serviços técnicos e auxiliares.
466	171901	17	19	1	Contabilidade, inclusive serviços técnicos e auxiliares.
467	\N	17	20	0	Consultoria e assessoria econômica ou financeira.
468	172001	17	20	1	Consultoria e assessoria econômica ou financeira.
469	\N	17	21	0	Estatística.
470	172101	17	21	1	Estatística.
471	\N	17	22	0	Cobrança em geral.
472	172201	17	22	1	Cobrança em geral.
473	\N	17	23	0	Assessoria, análise, avaliação, atendimento, consulta, cadastro, seleção, gerenciamento de informações, administração de contas a receber ou a pagar e em geral, relacionados a operações de faturização (factoring).
474	172301	17	23	1	Assessoria, análise, avaliação, atendimento, consulta, cadastro, seleção, gerenciamento de informações, administração de contas a receber ou a pagar e em geral, relacionados a operações de faturização (factoring).
475	\N	17	24	0	Apresentação de palestras, conferências, seminários e congêneres.
476	172401	17	24	1	Apresentação de palestras, conferências, seminários e congêneres.
477	\N	17	25	0	Inserção de textos, desenhos e outros materiais de propaganda e publicidade, em qualquer meio (exceto em livros, jornais, periódicos e nas modalidades de serviços de radiodifusão sonora e de sons e imagens de recepção livre e gratuita).
478	172501	17	25	1	Inserção de textos, desenhos e outros materiais de propaganda e publicidade, em qualquer meio (exceto em livros, jornais, periódicos e nas modalidades de serviços de radiodifusão sonora e de sons e imagens de recepção livre e gratuita).
479	\N	18	0	0	Serviços de regulação de sinistros vinculados a contratos de seguros; inspeção e avaliação de riscos para cobertura de contratos de seguros; prevenção e gerência de riscos seguráveis e congêneres.
480	\N	18	1	0	Serviços de regulação de sinistros vinculados a contratos de seguros; inspeção e avaliação de riscos para cobertura de contratos de seguros; prevenção e gerência de riscos seguráveis e congêneres.
481	180101	18	1	1	Serviços de regulação de sinistros vinculados a contratos de seguros e congêneres.
482	180102	18	1	2	Serviços de inspeção e avaliação de riscos para cobertura de contratos de seguros e congêneres.
483	180103	18	1	3	Serviços de prevenção e gerência de riscos seguráveis e congêneres.
484	\N	19	0	0	Serviços de distribuição e venda de bilhetes e demais produtos de loteria, bingos, cartões, pules ou cupons de apostas, sorteios, prêmios, inclusive os decorrentes de títulos de capitalização e congêneres.
485	\N	19	1	0	Serviços de distribuição e venda de bilhetes e demais produtos de loteria, bingos, cartões, pules ou cupons de apostas, sorteios, prêmios, inclusive os decorrentes de títulos de capitalização e congêneres.
486	190101	19	1	1	Serviços de distribuição e venda de bilhetes e demais produtos de loteria, cartões, pules ou cupons de apostas, sorteios, prêmios, inclusive os decorrentes de títulos de capitalização e congêneres.
487	190102	19	1	2	Serviços de distribuição e venda de bingos e congêneres.
488	\N	20	0	0	Serviços portuários, aeroportuários, ferroportuários, de terminais rodoviários, ferroviários e metroviários.
489	\N	20	1	0	Serviços portuários, ferroportuários, utilização de porto, movimentação de passageiros, reboque de embarcações, rebocador escoteiro, atracação, desatracação, serviços de praticagem, capatazia, armazenagem de qualquer natureza, serviços acessórios, movimentação de mercadorias, serviços de apoio marítimo, de movimentação ao largo, serviços de armadores, estiva, conferência, logística e congêneres.
490	200101	20	1	1	Serviços portuários, ferroportuários, utilização de porto, movimentação de passageiros, reboque de embarcações, rebocador escoteiro, atracação, desatracação, serviços de praticagem, capatazia, armazenagem de qualquer natureza, serviços acessórios, movimentação de mercadorias, serviços de apoio marítimo, de movimentação ao largo, serviços de armadores, estiva, conferência, logística e congêneres. (prestado em terra)
491	200102	20	1	2	Serviços portuários, ferroportuários, utilização de porto, movimentação de passageiros, reboque de embarcações, rebocador escoteiro, atracação, desatracação, serviços de praticagem, capatazia, armazenagem de qualquer natureza, serviços acessórios, movimentação de mercadorias, serviços de apoio marítimo, de movimentação ao largo, serviços de armadores, estiva, conferência, logística e congêneres. (prestado em águas marinhas)
492	\N	20	2	0	Serviços aeroportuários, utilização de aeroporto, movimentação de passageiros, armazenagem de qualquer natureza, capatazia, movimentação de aeronaves, serviços de apoio aeroportuários, serviços acessórios, movimentação de mercadorias, logística e congêneres.
493	200201	20	2	1	Serviços aeroportuários, utilização de aeroporto, movimentação de passageiros, armazenagem de qualquer natureza, capatazia, movimentação de aeronaves, serviços de apoio aeroportuários, serviços acessórios, movimentação de mercadorias, logística e congêneres.
494	\N	20	3	0	Serviços de terminais rodoviários, ferroviários, metroviários, movimentação de passageiros, mercadorias, inclusive suas operações, logística e congêneres.
495	200301	20	3	1	Serviços de terminais rodoviários, ferroviários, metroviários, movimentação de passageiros, mercadorias, inclusive suas operações, logística e congêneres.
496	\N	21	0	0	Serviços de registros públicos, cartorários e notariais.
497	\N	21	1	0	Serviços de registros públicos, cartorários e notariais.
498	210101	21	1	1	Serviços de registros públicos, cartorários e notariais.
499	\N	22	0	0	Serviços de exploração de rodovia.
500	\N	22	1	0	Serviços de exploração de rodovia mediante cobrança de preço ou pedágio dos usuários, envolvendo execução de serviços de conservação, manutenção, melhoramentos para adequação de capacidade e segurança de trânsito, operação, monitoração, assistência aos usuários e outros serviços definidos em contratos, atos de concessão ou de permissão ou em normas oficiais.
501	220101	22	1	1	Serviços de exploração de rodovia mediante cobrança de preço ou pedágio dos usuários, envolvendo execução de serviços de conservação, manutenção, melhoramentos para adequação de capacidade e segurança de trânsito, operação, monitoração, assistência aos usuários e outros serviços definidos em contratos, atos de concessão ou de permissão ou em normas oficiais.
502	\N	23	0	0	Serviços de programação e comunicação visual, desenho industrial e congêneres.
503	\N	23	1	0	Serviços de programação e comunicação visual, desenho industrial e congêneres.
504	230101	23	1	1	Serviços de programação e comunicação visual e congêneres.
505	230102	23	1	2	Serviços de desenho industrial e congêneres.
506	\N	24	0	0	Serviços de chaveiros, confecção de carimbos, placas, sinalização visual, banners, adesivos e congêneres.
507	\N	24	1	0	Serviços de chaveiros, confecção de carimbos, placas, sinalização visual, banners, adesivos e congêneres.
508	240101	24	1	1	Serviços de chaveiros, confecção de carimbos e congêneres.
509	240102	24	1	2	Serviços de placas, sinalização visual, banners, adesivos e congêneres.
510	\N	25	0	0	Serviços funerários.
511	\N	25	1	0	Funerais, inclusive fornecimento de caixão, urna ou esquifes; aluguel de capela; transporte do corpo cadavérico; fornecimento de flores, coroas e outros paramentos; desembaraço de certidão de óbito; fornecimento de véu, essa e outros adornos; embalsamento, embelezamento, conservação ou restauração de cadáveres.
512	250101	25	1	1	Funerais, inclusive fornecimento de caixão, urna ou esquifes; aluguel de capela; transporte do corpo cadavérico; fornecimento de flores, coroas e outros paramentos; desembaraço de certidão de óbito; fornecimento de véu, essa e outros adornos; embalsamento, embelezamento, conservação ou restauração de cadáveres.
513	\N	25	2	0	Translado intramunicipal e cremação de corpos e partes de corpos cadavéricos.
514	250201	25	2	1	Translado intramunicipal de corpos e partes de corpos cadavéricos.
515	250202	25	2	2	Cremação de corpos e partes de corpos cadavéricos.
516	\N	25	3	0	Planos ou convênio funerários.
517	250301	25	3	1	Planos ou convênio funerários.
518	\N	25	4	0	Manutenção e conservação de jazigos e cemitérios.
519	250401	25	4	1	Manutenção e conservação de jazigos e cemitérios.
520	\N	25	5	0	Cessão de uso de espaços em cemitérios para sepultamento.
521	250501	25	5	1	Cessão de uso de espaços em cemitérios para sepultamento.
522	\N	26	0	0	Serviços de coleta, remessa ou entrega de correspondências, documentos, objetos, bens ou valores, inclusive pelos correios e suas agências franqueadas; courrier e congêneres.
523	\N	26	1	0	Serviços de coleta, remessa ou entrega de correspondências, documentos, objetos, bens ou valores, inclusive pelos correios e suas agências franqueadas; courrier e congêneres.
524	260101	26	1	1	Serviços de coleta, remessa ou entrega de correspondências, documentos, objetos, bens ou valores, inclusive pelos correios e suas agências franqueadas.
525	260102	26	1	2	Serviços de courrier e congêneres.
526	\N	27	0	0	Serviços de assistência social.
527	\N	27	1	0	Serviços de assistência social.
528	270101	27	1	1	Serviços de assistência social.
529	\N	28	0	0	Serviços de avaliação de bens e serviços de qualquer natureza.
530	\N	28	1	0	Serviços de avaliação de bens e serviços de qualquer natureza.
531	280101	28	1	1	Serviços de avaliação de bens e serviços de qualquer natureza.
532	\N	29	0	0	Serviços de biblioteconomia.
533	\N	29	1	0	Serviços de biblioteconomia.
534	290101	29	1	1	Serviços de biblioteconomia.
535	\N	30	0	0	Serviços de biologia, biotecnologia e química.
536	\N	30	1	0	Serviços de biologia, biotecnologia e química.
537	300101	30	1	1	Serviços de biologia e biotecnologia.
538	300102	30	1	2	Serviços de química.
539	\N	31	0	0	Serviços técnicos em edificações, eletrônica, eletrotécnica, mecânica, telecomunicações e congêneres.
540	\N	31	1	0	Serviços técnicos em edificações, eletrônica, eletrotécnica, mecânica, telecomunicações e congêneres.
541	310101	31	1	1	Serviços técnicos em edificações e congêneres.
542	310102	31	1	2	Serviços técnicos em eletrônica, eletrotécnica e congêneres.
543	310103	31	1	3	Serviços técnicos em mecânica e congêneres.
544	310104	31	1	4	Serviços técnicos em telecomunicações e congêneres.
545	\N	32	0	0	Serviços de desenhos técnicos.
546	\N	32	1	0	Serviços de desenhos técnicos.
547	320101	32	1	1	Serviços de desenhos técnicos.
548	\N	33	0	0	Serviços de desembaraço aduaneiro, comissários, despachantes e congêneres.
549	\N	33	1	0	Serviços de desembaraço aduaneiro, comissários, despachantes e congêneres.
550	330101	33	1	1	Serviços de desembaraço aduaneiro, comissários, despachantes e congêneres.
551	\N	34	0	0	Serviços de investigações particulares, detetives e congêneres.
552	\N	34	1	0	Serviços de investigações particulares, detetives e congêneres.
553	340101	34	1	1	Serviços de investigações particulares, detetives e congêneres.
554	\N	35	0	0	Serviços de reportagem, assessoria de imprensa, jornalismo e relações públicas.
555	\N	35	1	0	Serviços de reportagem, assessoria de imprensa, jornalismo e relações públicas.
556	350101	35	1	1	Serviços de reportagem e jornalismo.
557	350102	35	1	2	Serviços de assessoria de imprensa.
558	350103	35	1	3	Serviços de relações públicas.
559	\N	36	0	0	Serviços de meteorologia.
560	\N	36	1	0	Serviços de meteorologia.
561	360101	36	1	1	Serviços de meteorologia.
562	\N	37	0	0	Serviços de artistas, atletas, modelos e manequins.
563	\N	37	1	0	Serviços de artistas, atletas, modelos e manequins.
564	370101	37	1	1	Serviços de artistas, atletas, modelos e manequins.
565	\N	38	0	0	Serviços de museologia.
566	\N	38	1	0	Serviços de museologia.
567	380101	38	1	1	Serviços de museologia.
568	\N	39	0	0	Serviços de ourivesaria e lapidação.
569	\N	39	1	0	Serviços de ourivesaria e lapidação (quando o material for fornecido pelo tomador do serviço).
570	390101	39	1	1	Serviços de ourivesaria e lapidação (quando o material for fornecido pelo tomador do serviço).
571	\N	40	0	0	Serviços relativos a obras de arte sob encomenda.
572	\N	40	1	0	Obras de arte sob encomenda.
573	400101	40	1	1	Obras de arte sob encomenda.
574	\N	99	0	0	Serviços sem a incidência de ISSQN e ICMS
575	\N	99	1	0	Serviços sem a incidência de ISSQN e ICMS
576	990101	99	1	1	Serviços sem a incidência de ISSQN e ICMS
\.


--
-- TOC entry 3478 (class 0 OID 16977)
-- Dependencies: 224
-- Data for Name: tb_sys_negocio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_sys_negocio (codigo, nome) FROM stdin;
1	PLACEHOLDER ONE
\.
...
-- Dependencies: 226
-- Name: nbs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.nbs_id_seq', 576, true);


--
-- TOC entry 3313 (class 2606 OID 17173)
-- Name: tb_stc_servico nbs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_stc_servico
    ADD CONSTRAINT nbs_pkey PRIMARY KEY (id);


--
-- TOC entry 3297 (class 2606 OID 16989)
...
--
-- TOC entry 3303 (class 2606 OID 16991)
-- Name: tb_cad_item pk_item; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_item
    ADD CONSTRAINT pk_item PRIMARY KEY (codigo, codigo_negocio, codigo_empresa);


--
-- TOC entry 3307 (class 2606 OID 16997)
-- Name: tb_cad_parceiro_negocio_contato pk_parceiro_contato; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_parceiro_negocio_contato
    ADD CONSTRAINT pk_parceiro_contato PRIMARY KEY (codigo, codigo_negocio, codigo_empresa, codigo_parceiro_negocio);


--
-- TOC entry 3305 (class 2606 OID 16999)
...
ALTER TABLE ONLY public.tb_cad_parceiro_negocio
    ADD CONSTRAINT pk_parceiro_negocio PRIMARY KEY (codigo, codigo_negocio, codigo_empresa);


--
-- TOC entry 3299 (class 2606 OID 17005)
-- Name: tb_adm_perfil tb_adm_perfil_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_adm_perfil
    ADD CONSTRAINT tb_adm_perfil_pkey PRIMARY KEY (codigo, codigo_negocio, codigo_empresa);


--
-- TOC entry 3301 (class 2606 OID 17007)
...
ALTER TABLE ONLY public.tb_cad_empresa
    ADD CONSTRAINT tb_cad_empresa_pkey PRIMARY KEY (codigo_negocio, codigo);


--
-- TOC entry 3309 (class 2606 OID 17009)
...
ALTER TABLE ONLY public.tb_cad_usuario
    ADD CONSTRAINT tb_cad_usuario_pkey PRIMARY KEY (codigo, codigo_negocio, codigo_empresa);


--
-- TOC entry 3311 (class 2606 OID 17013)
-- Name: tb_sys_negocio tb_sys_negocio_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_sys_negocio
    ADD CONSTRAINT tb_sys_negocio_pkey PRIMARY KEY (codigo);


--
-- TOC entry 3316 (class 2606 OID 17014)
-- Name: tb_cad_empresa fk_empresa_negocio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_empresa
    ADD CONSTRAINT fk_empresa_negocio FOREIGN KEY (codigo_negocio) REFERENCES public.tb_sys_negocio(codigo);


--
-- TOC entry 3321 (class 2606 OID 17049)
-- Name: tb_cad_parceiro_negocio_contato fk_parceiro_contato; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_parceiro_negocio_contato
    ADD CONSTRAINT fk_parceiro_contato FOREIGN KEY (codigo_parceiro_negocio, codigo_empresa, codigo_negocio) REFERENCES public.tb_cad_parceiro_negocio(codigo, codigo_empresa, codigo_negocio);


--
-- TOC entry 3322 (class 2606 OID 17054)
-- Name: tb_cad_parceiro_negocio_contato fk_parceiro_contato_empresa; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_parceiro_negocio_contato
    ADD CONSTRAINT fk_parceiro_contato_empresa FOREIGN KEY (codigo_empresa, codigo_negocio) REFERENCES public.tb_cad_empresa(codigo, codigo_negocio);


--
-- TOC entry 3323 (class 2606 OID 17059)
-- Name: tb_cad_parceiro_negocio_contato fk_parceiro_contato_negocio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_parceiro_negocio_contato
    ADD CONSTRAINT fk_parceiro_contato_negocio FOREIGN KEY (codigo_negocio) REFERENCES public.tb_sys_negocio(codigo);
...
ALTER TABLE ONLY public.tb_cad_parceiro_negocio
    ADD CONSTRAINT fk_parceiro_empresa FOREIGN KEY (codigo_empresa, codigo_negocio) REFERENCES public.tb_cad_empresa(codigo, codigo_negocio);


--
-- TOC entry 3320 (class 2606 OID 17069)
-- Name: tb_cad_parceiro_negocio fk_parceiro_negocio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_parceiro_negocio
    ADD CONSTRAINT fk_parceiro_negocio FOREIGN KEY (codigo_negocio) REFERENCES public.tb_sys_negocio(codigo);


--
-- TOC entry 3317 (class 2606 OID 17074)
-- Name: tb_cad_item fk_pedido_empresa; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_item
    ADD CONSTRAINT fk_pedido_empresa FOREIGN KEY (codigo_empresa, codigo_negocio) REFERENCES public.tb_cad_empresa(codigo, codigo_negocio);


--
-- TOC entry 3318 (class 2606 OID 17099)
-- Name: tb_cad_item fk_pedido_negocio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_item
    ADD CONSTRAINT fk_pedido_negocio FOREIGN KEY (codigo_negocio) REFERENCES public.tb_sys_negocio(codigo);


--
-- TOC entry 3314 (class 2606 OID 17129)
-- Name: tb_adm_perfil fk_perfil_empresa; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_adm_perfil
    ADD CONSTRAINT fk_perfil_empresa FOREIGN KEY (codigo_empresa, codigo_negocio) REFERENCES public.tb_cad_empresa(codigo, codigo_negocio);


--
-- TOC entry 3315 (class 2606 OID 17134)
-- Name: tb_adm_perfil fk_perfil_negocio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_adm_perfil
    ADD CONSTRAINT fk_perfil_negocio FOREIGN KEY (codigo_negocio) REFERENCES public.tb_sys_negocio(codigo);


--
-- TOC entry 3324 (class 2606 OID 17139)
-- Name: tb_cad_usuario fk_usuario_empresa; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_usuario
    ADD CONSTRAINT fk_usuario_empresa FOREIGN KEY (codigo_empresa, codigo_negocio) REFERENCES public.tb_cad_empresa(codigo, codigo_negocio);


--
-- TOC entry 3325 (class 2606 OID 17144)
-- Name: tb_cad_usuario fk_usuario_negocio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_cad_usuario
    ADD CONSTRAINT fk_usuario_negocio FOREIGN KEY (codigo_negocio) REFERENCES public.tb_sys_negocio(codigo);


-- Completed on 2025-10-01 21:51:48 -03

--
-- PostgreSQL database dump complete
--

\unrestrict j3IUhkYLrI8VnvRdXZmYO10oRVTL6CIcz4dbz53JIHclc3kKAIOebhk087gB3Cr
